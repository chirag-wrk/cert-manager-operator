...
func (b *TrustManagerStatusApplyConfiguration) WithSecretTargetsPolicy(value string) *TrustManagerStatusApplyConfiguration {
...
func (b *TrustManagerStatusApplyConfiguration) WithDefaultCAPackagePolicy(value string) *TrustManagerStatusApplyConfiguration {
...
func (b *TrustManagerStatusApplyConfiguration) WithFilterExpiredCertificatesPolicy(value string) *TrustManagerStatusApplyConfiguration {
